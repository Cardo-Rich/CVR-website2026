...
export const articles: Article[] = [
  {
    ...
    bodyHtml: `<p class="lede">Ask most owners what their home earns and they'll quote occupancy. But a home booked 300 nights at the wrong rate loses to one booked 220 nights at the right one. The number that matters is what lands on your statement. It's built from more than how full the calendar looks.</p>
        ...
        <div class="callout">
          ...
          <p>We price each home against its own demand curve, not a city average. Two homes a mile apart can have completely different best-case calendars. Pricing them the same leaves money on both.</p>
        </div>
  ...
  },
  {
    ...
    bodyHtml: `<p class="lede">Mt Ainsworth is the largest home in this group: five bedrooms, a pool, and a backyard built for entertaining.</p>
        ...
        <p>We furnished it as a true estate: cohesive rooms that photograph like a boutique hotel and a backyard styled into a destination of its own. After a single walkthrough, the owner left it entirely to us.</p>
